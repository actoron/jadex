...
public interface IJMonkeyRenderer
{
	...
	Spatial draw(DrawableCombiner3d dc, Primitive3d primitive, Object obj,
			ViewportJMonkey vp);

	Spatial prepareAndExecuteDraw(DrawableCombiner3d drawableCombiner3d,
			Primitive3d primitive, Object obj, ViewportJMonkey vp);
	
	Spatial prepareAndExecuteUpdate(DrawableCombiner3d drawableCombiner3d,
			Primitive3d primitive, Object obj, ViewportJMonkey vp, Spatial sp);

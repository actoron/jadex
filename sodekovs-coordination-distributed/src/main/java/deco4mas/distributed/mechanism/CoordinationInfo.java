 ...
 * These elements are exchanged between agent instances to indicate the occurrences of agent-internal events as well as to transfer agent-internal data.
 * 
...
public class CoordinationInfo implements CoordinationInformation, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8017945414367720093L;

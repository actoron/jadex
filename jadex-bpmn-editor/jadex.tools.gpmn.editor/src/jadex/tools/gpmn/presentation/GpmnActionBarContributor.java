...
/**
 * This is the action bar contributor for the Gpmn model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GpmnActionBarContributor extends EditingDomainActionBarContributor
		implements ISelectionChangedListener
{
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(GpmnEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
		{
			@Override
			public void run()
			{
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(GpmnEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
		{
			@Override
	 ...
	 * @generated
	 */
	public GpmnActionBarContributor()
	{
	...
	{
		toolBarManager.add(new Separator("gpmn-settings"));
		toolBarManager.add(new Separator("gpmn-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager)
	{
		...
		IMenuManager submenuManager = new MenuManager(GpmnEditorPlugin.INSTANCE.getString("_UI_GpmnEditor_menu"), "jadex.tools.gpmnMenuID");
		...
		//
		createChildMenuManager = new MenuManager(GpmnEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(GpmnEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager)
	{
		...
		submenuManager = new MenuManager(GpmnEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(GpmnEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));

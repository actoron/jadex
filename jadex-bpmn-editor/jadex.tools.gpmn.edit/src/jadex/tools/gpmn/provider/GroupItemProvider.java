...
/**
 * This is the item provider adapter for a {@link jadex.tools.gpmn.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider extends NamedObjectItemProvider implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GpmnPackage.Literals.GROUP__MEMBERS,
				 true,
				 false,
				 false,
	...
	protected void addCoordinatorPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_coordinator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_coordinator_feature", "_UI_Group_type"),
				 GpmnPackage.Literals.GROUP__COORDINATOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addHeadPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_head_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_head_feature", "_UI_Group_type"),
				 GpmnPackage.Literals.GROUP__HEAD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

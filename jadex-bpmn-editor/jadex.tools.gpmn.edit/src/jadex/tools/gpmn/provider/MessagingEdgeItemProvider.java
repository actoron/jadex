...
/**
 * This is the item provider adapter for a {@link jadex.tools.gpmn.MessagingEdge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessagingEdgeItemProvider extends InterGraphEdgeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessagingEdge_message_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MessagingEdge_message_feature", "_UI_MessagingEdge_type"),
				 GpmnPackage.Literals.MESSAGING_EDGE__MESSAGE,
				 true,
				 false,
				 false,

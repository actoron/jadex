...
/**
 * This is the item provider adapter for a {@link jadex.tools.gpmn.Vertex} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VertexItemProvider extends AssociationTargetItemProvider implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GpmnPackage.Literals.VERTEX__OUTGOING_EDGES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GpmnPackage.Literals.VERTEX__INCOMING_EDGES,
				 true,
				 false,
				 true,
				 null,

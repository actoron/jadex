 ...
 * @generated
 */
public class ContextElementItemProvider extends IdentifiableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ContextElement_dynamic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ContextElement_dynamic_feature", "_UI_ContextElement_type"),
				 GpmnPackage.Literals.CONTEXT_ELEMENT__DYNAMIC,
				 true,
				 false,
				 false,
	...
	protected void addInitialValuePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ContextElement_initialValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ContextElement_initialValue_feature", "_UI_ContextElement_type"),
				 GpmnPackage.Literals.CONTEXT_ELEMENT__INITIAL_VALUE,
				 true,
				 false,
				 false,
	...
	protected void addSetPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ContextElement_set_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ContextElement_set_feature", "_UI_ContextElement_type"),
	...
	protected void addTypePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ContextElement_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ContextElement_type_feature", "_UI_ContextElement_type"),

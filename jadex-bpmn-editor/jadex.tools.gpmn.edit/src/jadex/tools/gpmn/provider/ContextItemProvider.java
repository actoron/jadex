 ...
 * @generated
 */
public class ContextItemProvider extends ArtifactItemProvider implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Context_types_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Context_types_feature", "_UI_Context_type"),
				 GpmnPackage.Literals.CONTEXT__TYPES,
				 true,
				 false,
				 false,

...
/**
 * This is the item provider adapter for a {@link jadex.tools.gpmn.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider extends GraphItemProvider implements
		...
		ITableItemLabelProvider
{
	...
	protected void addLoopingPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_looping_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_looping_feature", "_UI_Process_type"),
				 GpmnPackage.Literals.PROCESS__LOOPING,
				 true,
				 false,
				 false,
	...
	{
		String label = ((jadex.tools.gpmn.Process)object).getName();
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(jadex.tools.gpmn.Process.class))
		{

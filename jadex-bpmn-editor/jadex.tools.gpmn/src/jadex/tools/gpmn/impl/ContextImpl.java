 ...
 * @generated
 */
public class ContextImpl extends ArtifactImpl implements Context
{
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<ContextElement> getElements()
	{
		if (elements == null)
		{
			elements = new EObjectContainmentWithInverseEList<ContextElement>(ContextElement.class, this, GpmnPackage.CONTEXT__ELEMENTS, GpmnPackage.CONTEXT_ELEMENT__CONTEXT);
		}
		return elements;
	}
	...
	public void setTypes(String newTypes)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpmnPackage.CONTEXT__TYPES, oldTypes, types));
	}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sequential Goal</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jadex.tools.gpmn.impl.SequentialGoalImpl#getTargetcondition <em>Targetcondition</em>}</li>
 *   <li>{@link jadex.tools.gpmn.impl.SequentialGoalImpl#getTargetconditionLanguage <em>Targetcondition Language</em>}</li>
 *   <li>{@link jadex.tools.gpmn.impl.SequentialGoalImpl#getFailurecondition <em>Failurecondition</em>}</li>
 *   <li>{@link jadex.tools.gpmn.impl.SequentialGoalImpl#getFailureconditionLanguage <em>Failurecondition Language</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SequentialGoalImpl extends GoalImpl implements
		SequentialGoal
{
	/**
	 * <!-- begin-user-doc -->
	...
	{
		return GpmnPackage.Literals.SEQUENTIAL_GOAL;
	}
	...
	public void setTargetcondition(String newTargetcondition)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpmnPackage.SEQUENTIAL_GOAL__TARGETCONDITION, oldTargetcondition, targetcondition));
	}
	...
	public void setTargetconditionLanguage(String newTargetconditionLanguage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpmnPackage.SEQUENTIAL_GOAL__TARGETCONDITION_LANGUAGE, oldTargetconditionLanguage, targetconditionLanguage, !oldTargetconditionLanguageESet));
	}
	...
	public void unsetTargetconditionLanguage()
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GpmnPackage.SEQUENTIAL_GOAL__TARGETCONDITION_LANGUAGE, oldTargetconditionLanguage, TARGETCONDITION_LANGUAGE_EDEFAULT, oldTargetconditionLanguageESet));
	}
	...
	public void setFailurecondition(String newFailurecondition)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpmnPackage.SEQUENTIAL_GOAL__FAILURECONDITION, oldFailurecondition, failurecondition));
	}
	...
	public void setFailureconditionLanguage(String newFailureconditionLanguage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpmnPackage.SEQUENTIAL_GOAL__FAILURECONDITION_LANGUAGE, oldFailureconditionLanguage, failureconditionLanguage, !oldFailureconditionLanguageESet));
	}
	...
	public void unsetFailureconditionLanguage()
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GpmnPackage.SEQUENTIAL_GOAL__FAILURECONDITION_LANGUAGE, oldFailureconditionLanguage, FAILURECONDITION_LANGUAGE_EDEFAULT, oldFailureconditionLanguageESet));
	}

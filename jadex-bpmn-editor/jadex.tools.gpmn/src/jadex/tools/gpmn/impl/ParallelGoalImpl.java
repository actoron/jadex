...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Parallel Goal</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jadex.tools.gpmn.impl.ParallelGoalImpl#getTargetcondition <em>Targetcondition</em>}</li>
 *   <li>{@link jadex.tools.gpmn.impl.ParallelGoalImpl#getTargetconditionLanguage <em>Targetcondition Language</em>}</li>
 *   <li>{@link jadex.tools.gpmn.impl.ParallelGoalImpl#getFailurecondition <em>Failurecondition</em>}</li>
 *   <li>{@link jadex.tools.gpmn.impl.ParallelGoalImpl#getFailureconditionLanguage <em>Failurecondition Language</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ParallelGoalImpl extends GoalImpl implements ParallelGoal
{
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	{
		return GpmnPackage.Literals.PARALLEL_GOAL;
	}
	...
	public void setTargetcondition(String newTargetcondition)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpmnPackage.PARALLEL_GOAL__TARGETCONDITION, oldTargetcondition, targetcondition));
	}
	...
	public void setTargetconditionLanguage(String newTargetconditionLanguage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpmnPackage.PARALLEL_GOAL__TARGETCONDITION_LANGUAGE, oldTargetconditionLanguage, targetconditionLanguage, !oldTargetconditionLanguageESet));
	}
	...
	public void unsetTargetconditionLanguage()
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GpmnPackage.PARALLEL_GOAL__TARGETCONDITION_LANGUAGE, oldTargetconditionLanguage, TARGETCONDITION_LANGUAGE_EDEFAULT, oldTargetconditionLanguageESet));
	}
	...
	public void setFailurecondition(String newFailurecondition)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpmnPackage.PARALLEL_GOAL__FAILURECONDITION, oldFailurecondition, failurecondition));
	}
	...
	public void setFailureconditionLanguage(String newFailureconditionLanguage)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GpmnPackage.PARALLEL_GOAL__FAILURECONDITION_LANGUAGE, oldFailureconditionLanguage, failureconditionLanguage, !oldFailureconditionLanguageESet));
	}
	...
	public void unsetFailureconditionLanguage()
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GpmnPackage.PARALLEL_GOAL__FAILURECONDITION_LANGUAGE, oldFailureconditionLanguage, FAILURECONDITION_LANGUAGE_EDEFAULT, oldFailureconditionLanguageESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case GpmnPackage.PARALLEL_GOAL__TARGETCONDITION:
				return getTargetcondition();
			case GpmnPackage.PARALLEL_GOAL__TARGETCONDITION_LANGUAGE:
				return getTargetconditionLanguage();
			case GpmnPackage.PARALLEL_GOAL__FAILURECONDITION:
				return getFailurecondition();
			case GpmnPackage.PARALLEL_GOAL__FAILURECONDITION_LANGUAGE:

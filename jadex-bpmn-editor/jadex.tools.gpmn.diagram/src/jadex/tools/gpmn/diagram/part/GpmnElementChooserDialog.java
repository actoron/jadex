 ...
 * @generated
 */
public class GpmnElementChooserDialog extends Dialog
{
	 ...
	 * @generated
	 */
	public GpmnElementChooserDialog(Shell parentShell, View view)
	{
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent)
	{
		...
		getShell().setText(
				Messages.GpmnElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file)
	{
		...
		return "Gpmn".equals(fileExtension); //$NON-NLS-1$
	}

...
import jadex.tools.gpmn.diagram.edit.policies.MessageGoalItemSemanticEditPolicy;
 ...
 */
public class MessageGoalEditPart extends GoalEditPartSupport
{
	 ...
	 * @generated
	 */
	public MessageGoalEditPart(View view)
	{
		super(view);
	}
	...
	protected void createDefaultEditPolicies()
	{
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MessageGoalItemSemanticEditPolicy());
	...
	{
		if (childEditPart instanceof MessageGoalNameEditPart)
		{
			((MessageGoalNameEditPart) childEditPart)

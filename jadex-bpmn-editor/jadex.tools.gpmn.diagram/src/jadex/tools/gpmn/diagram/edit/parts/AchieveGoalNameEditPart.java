 ...
 * @generated
 */
public class AchieveGoalNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart
{
	 ...
	 * @generated
	 */
	public AchieveGoalNameEditPart(View view)
	{
		super(view);
	}
	...
	public IParser getParser()
	{
		if (parser == null)
		{
			parser = GpmnParserProvider
					.getParser(
							GpmnElementTypes.AchieveGoal_2002,
							getParserElement(),
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.AchieveGoalNameEditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class SubProcessGoalNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart
{
	 ...
	 * @generated
	 */
	public SubProcessGoalNameEditPart(View view)
	{
		super(view);
	}
			...
			parser = GpmnParserProvider
					.getParser(
							...
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.SubProcessGoalNameEditPart.VISUAL_ID));
		}
		return parser;
	}

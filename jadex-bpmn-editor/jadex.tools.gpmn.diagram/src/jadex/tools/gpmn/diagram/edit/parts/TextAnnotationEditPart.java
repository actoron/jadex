...
import jadex.tools.gpmn.diagram.edit.policies.TextAnnotationItemSemanticEditPolicy;
...
public class TextAnnotationEditPart extends ShapeNodeEditPart
{
	...
	public class TextAnnotationFigure extends RectangleFigure
	{
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureTextAnnotationDescriptionFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureTextAnnotationNameFigure;
		...
		private void createContents()
		{
			...
			fFigureTextAnnotationDescriptionFigure = new WrappingLabel();
			fFigureTextAnnotationDescriptionFigure.setText("Description");

			this.add(fFigureTextAnnotationDescriptionFigure);

			fFigureTextAnnotationNameFigure = new WrappingLabel();
			fFigureTextAnnotationNameFigure.setText("Text Annotation");

			this.add(fFigureTextAnnotationNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureTextAnnotationDescriptionFigure()
		{
			return fFigureTextAnnotationDescriptionFigure;
		}
		...
		{
			return fFigureTextAnnotationNameFigure;
		}

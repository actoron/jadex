 ...
 * @generated
 */
public class MessagingEdgeCreateCommand extends EditElementCommand
{
	 ...
	 * @generated
	 */
	public MessagingEdgeCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute()
	{
		...
		if (source != null && false == source instanceof InterGraphVertex)
		{
			return false;
		}
		if (target != null && false == target instanceof InterGraphVertex)
		{
			return false;
		}
		if (getSource() == null)
		...
		return GpmnBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateMessagingEdge_4004(getContainer(), getSource(),
						getTarget());
	}
			...
			IAdaptable info) throws ExecutionException
	{
		...
		MessagingEdge newElement = GpmnFactory.eINSTANCE.createMessagingEdge();
	 ...
	 * @generated
	 */
	protected void doConfigure(MessagingEdge newElement,
	 ...
	 * @generated
	 */
	protected InterGraphVertex getSource()
	{
		return (InterGraphVertex) source;
	}

	/**
	 * @generated
	 */
	protected InterGraphVertex getTarget()
	{
		return (InterGraphVertex) target;
	}

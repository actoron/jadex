...
import jadex.tools.gpmn.diagram.edit.policies.PerformGoalItemSemanticEditPolicy;
 ...
 */
public class PerformGoalEditPart extends GoalEditPartSupport
{
	 ...
	 * @generated
	 */
	public PerformGoalEditPart(View view)
	{
		super(view);
	}
	...
	protected void createDefaultEditPolicies()
	{
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PerformGoalItemSemanticEditPolicy());
	...
	{
		if (childEditPart instanceof PerformGoalNameEditPart)
		{
			((PerformGoalNameEditPart) childEditPart)

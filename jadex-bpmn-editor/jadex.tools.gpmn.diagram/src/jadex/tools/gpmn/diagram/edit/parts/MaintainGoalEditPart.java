...
import jadex.tools.gpmn.diagram.edit.policies.MaintainGoalItemSemanticEditPolicy;
 ...
 */
public class MaintainGoalEditPart extends GoalEditPartSupport
{
	 ...
	 * @generated
	 */
	public MaintainGoalEditPart(View view)
	{
		super(view);
	}
	...
	protected void createDefaultEditPolicies()
	{
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MaintainGoalItemSemanticEditPolicy());
	...
	{
		if (childEditPart instanceof MaintainGoalNameEditPart)
		{
			((MaintainGoalNameEditPart) childEditPart)

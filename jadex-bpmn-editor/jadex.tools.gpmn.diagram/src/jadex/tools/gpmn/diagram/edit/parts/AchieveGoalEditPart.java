...
import jadex.tools.gpmn.diagram.edit.policies.AchieveGoalItemSemanticEditPolicy;
 ...
 */
public class AchieveGoalEditPart extends GoalEditPartSupport
{
	 ...
	 * @generated
	 */
	public AchieveGoalEditPart(View view)
	{
		super(view);
	}
	...
	protected void createDefaultEditPolicies()
	{
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AchieveGoalItemSemanticEditPolicy());
	...
	{
		if (childEditPart instanceof AchieveGoalNameEditPart)
		{
			((AchieveGoalNameEditPart) childEditPart)

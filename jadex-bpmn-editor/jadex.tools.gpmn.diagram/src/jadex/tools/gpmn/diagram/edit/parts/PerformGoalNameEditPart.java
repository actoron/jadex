 ...
 * @generated
 */
public class PerformGoalNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart
{
	 ...
	 * @generated
	 */
	public PerformGoalNameEditPart(View view)
	{
		super(view);
	}
	...
	public IParser getParser()
	{
		if (parser == null)
		{
			parser = GpmnParserProvider
					.getParser(
							GpmnElementTypes.PerformGoal_2004,
							getParserElement(),
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.PerformGoalNameEditPart.VISUAL_ID));
		}
		return parser;
	}

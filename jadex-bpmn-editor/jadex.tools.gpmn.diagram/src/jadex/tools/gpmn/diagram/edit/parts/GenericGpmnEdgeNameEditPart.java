 ...
 * @generated
 */
public class GenericGpmnEdgeNameEditPart extends LabelEditPart implements
		ITextAwareEditPart
{
	...
	static
	{
		registerSnapBackPosition(
				GpmnVisualIDRegistry
						.getType(jadex.tools.gpmn.diagram.edit.parts.GenericGpmnEdgeNameEditPart.VISUAL_ID),
				new Point(0, -10));
	}
	 ...
	 * @generated
	 */
	public GenericGpmnEdgeNameEditPart(View view)
	{
		super(view);
	}

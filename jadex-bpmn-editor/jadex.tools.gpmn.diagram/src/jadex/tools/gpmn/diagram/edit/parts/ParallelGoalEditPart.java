...
import jadex.tools.gpmn.diagram.edit.policies.ParallelGoalItemSemanticEditPolicy;
 ...
 */
public class ParallelGoalEditPart extends GoalEditPartSupport
{
	 ...
	 * @generated
	 */
	public ParallelGoalEditPart(View view)
	{
		super(view);
	}
	...
	protected void createDefaultEditPolicies()
	{
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ParallelGoalItemSemanticEditPolicy());
	...
	{
		if (childEditPart instanceof ParallelGoalNameEditPart)
		{
			((ParallelGoalNameEditPart) childEditPart)

 ...
 * @generated
 */
public class ParallelGoalNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart
{
	 ...
	 * @generated
	 */
	public ParallelGoalNameEditPart(View view)
	{
		super(view);
	}
			...
			parser = GpmnParserProvider
					.getParser(
							...
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.ParallelGoalNameEditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class PlanNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart
{
	 ...
	 * @generated
	 */
	public PlanNameEditPart(View view)
	{
		super(view);
	}
	...
	public IParser getParser()
	{
		if (parser == null)
		{
			parser = GpmnParserProvider
					.getParser(
							GpmnElementTypes.Plan_2010,
							getParserElement(),
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.PlanNameEditPart.VISUAL_ID));
		}
		return parser;
	}

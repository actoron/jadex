 ...
 * @generated
 */
public class QueryGoalNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart
{
	 ...
	 * @generated
	 */
	public QueryGoalNameEditPart(View view)
	{
		super(view);
	}
			...
			parser = GpmnParserProvider
					.getParser(
							...
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.QueryGoalNameEditPart.VISUAL_ID));
		}
		return parser;
	}

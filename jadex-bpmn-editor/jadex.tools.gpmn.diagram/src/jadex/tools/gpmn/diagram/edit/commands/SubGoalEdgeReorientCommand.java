 ...
 * @generated
 */
public class SubGoalEdgeReorientCommand extends EditElementCommand
{
	 ...
	 * @generated
	 */
	public SubGoalEdgeReorientCommand(ReorientRelationshipRequest request)
	{
	...
	{
		if (false == getElementToEdit() instanceof SubGoalEdge)
		{
			return false;
		}
	...
	protected boolean canReorientSource()
	{
		...
		return GpmnBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSubGoalEdge_4002(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget()
	{
		...
		Graph container = (Graph) getLink().eContainer();
		return GpmnBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSubGoalEdge_4002(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected SubGoalEdge getLink()
	{
		return (SubGoalEdge) getElementToEdit();
	}

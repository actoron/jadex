 ...
 * @generated
 */
public class SubGoalEdgeSequentialOrderEditPart extends LabelEditPart implements
		ITextAwareEditPart
{
	...
	/**
	 * @generated NOT
	 * 		Changed snap back point to have the label nearer the edge
	 */
	static
	{
		registerSnapBackPosition(GpmnVisualIDRegistry
	 ...
	 * @generated
	 */
	public SubGoalEdgeSequentialOrderEditPart(View view)
	{
		super(view);
	}
	...
	/**
	 * @generated NOT, don't edit the edit part if the source isn't sequential
	 */
	protected boolean isEditable()
	{
		// return getParser() != null;
		boolean canEdit = getParser() != null;
		if(canEdit)
		{
			return activateSequentialOrderDirectEdit();
		}
		else
		{
			return canEdit;
	...
	/**
	 * Check if direct label edit is useful
	 * @return true if the parent connections source is sequential
	 * @generated NOT
	 */
	protected boolean activateSequentialOrderDirectEdit()
	{
		EditPart parent = getParent();
		if (parent instanceof ConnectionEditPart)
		{
			EditPart source = ((ConnectionEditPart) parent).getSource();
			if (source instanceof GoalEditPartSupport)
			{
				Goal sourceGoal = (Goal) ((GoalEditPartSupport) source).resolveSemanticElement();
				return sourceGoal.isSequential();
			}
		}
			...
			parser = GpmnParserProvider
					.getParser(
							...
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.SubGoalEdgeSequentialOrderEditPart.VISUAL_ID));
		}
		return parser;
	}

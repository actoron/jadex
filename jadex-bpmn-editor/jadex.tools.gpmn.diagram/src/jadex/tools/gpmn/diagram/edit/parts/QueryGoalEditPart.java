...
import jadex.tools.gpmn.diagram.edit.policies.QueryGoalItemSemanticEditPolicy;
 ...
 */
public class QueryGoalEditPart extends GoalEditPartSupport
{
	 ...
	 * @generated
	 */
	public QueryGoalEditPart(View view)
	{
		super(view);
	}
	...
	protected void createDefaultEditPolicies()
	{
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new QueryGoalItemSemanticEditPolicy());
	...
	{
		if (childEditPart instanceof QueryGoalNameEditPart)
		{
			((QueryGoalNameEditPart) childEditPart).setLabel(getPrimaryShape()

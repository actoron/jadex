...
public class AssociationCreateCommand extends EditElementCommand
{
	...
	public boolean canExecute()
	{
		...
		if (target != null && false == target instanceof AssociationTarget)
		{
			return false;
		}
		if (getSource() == null)
			...
			IAdaptable info) throws ExecutionException
	{
		...
		Association newElement = GpmnFactory.eINSTANCE.createAssociation();
	 ...
	 * @generated
	 */
	protected AssociationTarget getTarget()
	{
		return (AssociationTarget) target;
	}
	 ...
	 * @generated
	 */
	private static Artifact deduceContainer(EObject source, EObject target)
	{

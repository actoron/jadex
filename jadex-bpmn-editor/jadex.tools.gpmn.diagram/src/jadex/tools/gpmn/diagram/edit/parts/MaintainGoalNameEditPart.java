 ...
 * @generated
 */
public class MaintainGoalNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart
{
	 ...
	 * @generated
	 */
	public MaintainGoalNameEditPart(View view)
	{
		super(view);
	}
			...
			parser = GpmnParserProvider
					.getParser(
							...
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.MaintainGoalNameEditPart.VISUAL_ID));
		}
		return parser;
	}

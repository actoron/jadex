 ...
 * @generated
 */
public class SequentialGoalNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart
{
	 ...
	 * @generated
	 */
	public SequentialGoalNameEditPart(View view)
	{
		super(view);
	}
			...
			parser = GpmnParserProvider
					.getParser(
							...
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.SequentialGoalNameEditPart.VISUAL_ID));
		}
		return parser;
	}

...
import jadex.tools.gpmn.diagram.edit.commands.MessagingEdgeCreateCommand;
import jadex.tools.gpmn.diagram.edit.commands.MessagingEdgeReorientCommand;
 ...
 * @generated
 */
public class MessageGoalItemSemanticEditPolicy extends
		GpmnBaseItemSemanticEditPolicy
{
	 ...
	 * @generated
	 */
	public MessageGoalItemSemanticEditPolicy()
	{
		super(GpmnElementTypes.MessageGoal_2008);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req)
	{
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();)
		{
			...
			if (GpmnVisualIDRegistry.getVisualID(incomingLink) == MessagingEdgeEditPart.VISUAL_ID)
			{
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();)
		{
			...
			if (GpmnVisualIDRegistry.getVisualID(outgoingLink) == MessagingEdgeEditPart.VISUAL_ID)
			{
				DestroyElementRequest r = new DestroyElementRequest(
						outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
			...
			CreateRelationshipRequest req)
	{
		...
		if (GpmnElementTypes.MessagingEdge_4004 == req.getElementType())
		{
			return getGEFWrapper(new MessagingEdgeCreateCommand(req, req
					.getSource(), req.getTarget()));
		}
			...
			ReorientRelationshipRequest req)
	{
		switch (getVisualID(req))
		{
			...
			case MessagingEdgeEditPart.VISUAL_ID:
				return getGEFWrapper(new MessagingEdgeReorientCommand(req));

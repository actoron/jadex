 ...
 * @generated
 */
public class GenericGpmnEdgeReorientCommand extends EditElementCommand
{
	 ...
	 * @generated
	 */
	public GenericGpmnEdgeReorientCommand(ReorientRelationshipRequest request)
	{
	...
	{
		if (false == getElementToEdit() instanceof GenericGpmnEdge)
		{
			return false;
		}
	...
	protected boolean canReorientSource()
	{
		...
		return GpmnBaseItemSemanticEditPolicy.LinkConstraints
				.canExistGenericGpmnEdge_4005(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget()
	{
		...
		Graph container = (Graph) getLink().eContainer();
		return GpmnBaseItemSemanticEditPolicy.LinkConstraints
				.canExistGenericGpmnEdge_4005(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected GenericGpmnEdge getLink()
	{
		return (GenericGpmnEdge) getElementToEdit();
	}

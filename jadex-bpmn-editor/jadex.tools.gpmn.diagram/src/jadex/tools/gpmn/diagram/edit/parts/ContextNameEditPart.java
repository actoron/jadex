		...
		ITextAwareEditPart
{
	...
	protected Image getLabelIcon()
	{
		...
		return GpmnElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser()
	{
		if (parser == null)
		{
			parser = GpmnParserProvider
					.getParser(
							GpmnElementTypes.Context_2011,
							getParserElement(),
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.ContextNameEditPart.VISUAL_ID));
		}
		return parser;
	}

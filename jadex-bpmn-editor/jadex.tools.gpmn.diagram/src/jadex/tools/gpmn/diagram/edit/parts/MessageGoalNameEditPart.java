 ...
 * @generated
 */
public class MessageGoalNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart
{
	 ...
	 * @generated
	 */
	public MessageGoalNameEditPart(View view)
	{
		super(view);
	}
	...
	public IParser getParser()
	{
		if (parser == null)
		{
			parser = GpmnParserProvider
					.getParser(
							GpmnElementTypes.MessageGoal_2008,
							getParserElement(),
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.MessageGoalNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager()
	{
		if (manager == null)
		{
			setManager(new TextDirectEditManager(this, GpmnEditPartFactory

...
public class SelectGPMNDiagramFileAction extends AbstractFileAction implements IObjectActionDelegate
{
	...
	public void run(IAction action)
	{
		...
		String gpmnDiagramFile = ((SubProcessGoal) ((View) selectedElement.getModel()).getElement()).getGoalref();
		...
		final SubProcessGoal goal = (SubProcessGoal) ((View) selectedElement.getModel()).getElement();

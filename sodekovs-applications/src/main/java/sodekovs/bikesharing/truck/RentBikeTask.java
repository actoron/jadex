package sodekovs.bikesharing.truck;
...
//				System.out.println("Nest Pos: " + nest.getProperty(ContinuousSpace2D.PROPERTY_POSITION) + " ant Pos: " + so.getProperty(ContinuousSpace2D.PROPERTY_POSITION));
				...
				int takeAway = stock/2;
//				int capacity = (Integer) bikestation.getProperty("capacity");
				//TODO: assert: stock > 1 before renting capacity				
				bikestation.setProperty("stock", stock - takeAway);
				myself.setProperty("nrOfBikes", takeAway);
				break;
			}
		}

...
import sodekovs.bikesharing.verkehrsteilnehmer.GehZuFuss;
import sodekovs.bikesharing.verkehrsteilnehmer.NutzeBahn;


/**
 * Eine Klasse, um Wege zu speichern, wie Verkehrsteilnehmer sie benötigen 
 * (d.h. mit Anweisungen, mit welchem Verkehrsmittel der Weg zu bewältigen ist)
 * Dabei soll insbesondere darauf R�cksicht genommen werden, dass 
 * Vergleichskriterien ben�tigt werden, um zu entscheiden, ob ein Weg gew�hlt wird oder nicht
 * @author dagere
 *
 */
public class VerkehrsteilnehmerWeg extends Weg
{
	 ...
	 * @param station	Stationsnummer, die gesetzt werden soll
	 * @param typ		Wegtyp zwischen 2 Stationen
	 */
	 ...
	 * @param position Position, an der das nächste Ziel angegeben werden soll
	 * @return
	 */
	 ...
	 * @param position Position, an dem der nächste Wegtyp angegeben werden soll
	 * @return
	 */
	...
	/**
	 * Gibt die Unbequemlichkeit des Weges aus, dabei ist eine möglichst geringe
	 * Unbequemlichkeit gut
	 * @return
	 */
	 ...
	 * @param radanteil	Wert für den Radanteil
	 */
	...
	/**
	 * Fügt die gegebene Weglänge zum Wissen über Weglängen hinzu; dabei wird die Länge mit den bisher ermittelten Längen
	 * gewichtet, und daraus die neue durchschnittliche Weglänge berechnet
	 * @param zeit	Weglänge, die dieses mal benötigt wurde
	 */
	...
	/**
	 * Löscht den letzten Fußweg der Strecke (für den Fall,
	 * dass ein falscher Fußweg gegangen wurde)
	 */
	...
	/**
	 * Gibt die Umkehrung des Weges, also den Weg vom Ziel zum Start mit der
	 * umgekehrten Reihenfolge der Stationen

...
/**
 * Plan is called whenever the stock or capacity of the station changes. The plan changes the alternative stations if they are not needed anymore and informs other stations about the changed occupancy
 * using DeCoMAS if the state has changed (full, empty or normal).
 * 

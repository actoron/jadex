 ...
 * 
 * Interface for CoordinationInformationInterpreter
 * can be removed!
 */
...
//	public void	agentRemoved(IAgentIdentifier aid);
	...
	/**
	 * This method checks if a Coordination Information triggers the dispatchment 
	 * (positive direction) or removal (negative direction) of an agent property like belief, goal or ISpaceProperty. 
	 *  

 ...
 * can be removed!
 */
public class BDICoordinationInterpreter extends SimplePropertyObject implements
	...
	/* (non-Javadoc)
	 * @see deco4mas.coordinate.interpreter.coordination_information.ICoordinationInformationInterpreter#dispatchWhenApplicable(java.lang.String, java.lang.Object, jadex.bridge.IAgentIdentifier, jadex.adapter.base.envsupport.environment.ISpaceObject)
	 */
//	@Override
...
//	}
	...
	/* (non-Javadoc)
	 * @see deco4mas.coordinate.interpreter.coordination_information.ICoordinationInformationInterpreter#processPercept(jadex.bridge.ISpace, java.lang.String, java.lang.Object, jadex.bridge.IAgentIdentifier, jadex.adapter.base.envsupport.environment.ISpaceObject)
	 */
//	@Override
	public void processPercept(final ISpace space, final String type, final Object percept, final IAgentIdentifier agent, final ISpaceObject avatar) {
		...
		System.out.println("#BDICoordinationInterpreter # Trying to process percept....");
		...
		if(invoke)
		{
			System.out.println("#BDICoordinationInterpreter # invoked....");

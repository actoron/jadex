...
//			
//			
//			// Divide pheromone strength according to the number of grids it is propagated within the next step.
...
//			System.out.println("#ManagePheromonesProcess-Evaporation# Computed Strength: " + newPheromoneStrength + " for source Pheromone: "  + object.toString());
//
...
//				pheromone.setProperty(ProducePheromoneAction.STRENGTH, new Integer(pheromoneStrength + oldPheromoneStrength));
//				System.out.println("#ManagePheromonesProcess# Updated Pheromone because of Propagation wit max Value: " + pos.toString() + ", 10");
//			}

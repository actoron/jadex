...
public abstract class Creature extends WorldObject
{
	...
	/** Creature size
	 */
	public static final IVector1 CREATURE_VISUAL_RANGE = new Vector1Int(4);
	public static final IVector2 CREATURE_SIZE = new Vector2Int(1);
	public static final IVector1 CREATURE_SPEED = new Vector1Int(1);

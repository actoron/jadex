...
@Properties({@NameValue(name=Testcase.PROPERTY_TEST_TIMEOUT, value="jadex.base.Starter.getScaledRemoteDefaultTimeout(null, 1.5)")}) // cannot use $component.getComponentIdentifier() because is extracted from test suite :-(
@Service

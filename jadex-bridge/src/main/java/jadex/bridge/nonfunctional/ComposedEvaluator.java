...
//		double ret = 0;
	 ...
	 */
	public IFuture<List<IService>> rank(final List<IService> unrankedservices)
	{
		...
		final CounterResultListener<Void> crl = new CounterResultListener<Void>(unrankedservices.size(), new IResultListener<Void>()
		{
			...
			{
				Collections.sort(unrankedservices, new Comparator<IService>()
				{
		...
		{
			final IService service = unrankedservices.get(i);

...
//		ISearchManager manager, IVisitDecider decider, IResultSelector selector);
	 ...
	 */
	public <T> IFuture<T> getServiceProxy(IComponentIdentifier cid, Class<T> service, String scope, IAsyncFilter<T> filter);
	 ...
	 *  @return The service proxy.
	 */
	public <T> IFuture<Collection<T>> getServiceProxies(IComponentIdentifier cid, Class<T> service, String scope, IAsyncFilter<T> filter);

 ...
 */
public class MultiServiceRegistryOld implements IMultiServiceRegistry//extends IServiceRegistry
{
...
//	protected Map<ClassInfo, Set<ServiceQueryInfo<?>>> queries;
	 ...
	 */
	public MultiServiceRegistryOld()
	{
	}
...
//	}
	 ...
	 */
	public IFuture<Void> addService(ClassInfo key, final IService service)
	{
		final Future<Void> ret = new Future<Void>();
		IServiceRegistry reg = getSubregistry(service.getServiceIdentifier().getProviderId());
		reg.addService(key, service).addResultListener(new DelegationResultListener<Void>(ret));
...
//			{
//				checkQueries(service).addResultListener(new DelegationResultListener<Void>(ret));
//				
//			}
//		});
		return ret;
...
//			}
//		}
//		if (reg.isIncluded(cid, null))
//		{
//			reg.removeExcludedComponent(cid).addResultListener(new IResultListener<Void>()
//			{
//				public void resultAvailable(Void result)
//				{
//					checkq

 ...
 * 
 */
public class JadexTimerEventFilter implements IFilter
{
	public boolean select(Object toTest)
	{
		...
		if (toTest instanceof ActivityEditPart || toTest instanceof Activity2EditPart)
		{
			...
			if (part.getModel() instanceof View)
			{
				...
				ret = ActivityType.EVENT_INTERMEDIATE_TIMER_LITERAL.equals(model.getActivityType())
					|| ActivityType.EVENT_START_TIMER_LITERAL.equals(model.getActivityType());
			}
		}

		...
		AbstractCommonTablePropertySection
{
	...
	/**
	 * @see jadex.editor.common.model.properties.table.AbstractCommonTablePropertySection#getDeleteCommand()
	 */
	@Override
	...
	/**
	 * @see jadex.editor.common.model.properties.table.AbstractCommonTablePropertySection#getTableContentProvider()
	 */
	@Override

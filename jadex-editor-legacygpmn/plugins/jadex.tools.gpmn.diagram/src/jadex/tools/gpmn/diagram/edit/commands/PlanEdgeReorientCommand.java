...
public class PlanEdgeReorientCommand extends EditElementCommand
{
	...
	protected boolean canReorientSource()
	{
		...
		AbstractPlan target = getLink().getTarget();
		...
		return GpmnBaseItemSemanticEditPolicy.LinkConstraints
				.canExistPlanEdge_4002(container, getNewSource(), target);
	}
	...
	{
		if (!(oldEnd instanceof AbstractPlan && newEnd instanceof AbstractPlan))
		{
			return false;
		}
		...
		GpmnDiagram container = (GpmnDiagram) getLink().eContainer();
		return GpmnBaseItemSemanticEditPolicy.LinkConstraints
				.canExistPlanEdge_4002(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected AbstractPlan getOldTarget()
	{
		return (AbstractPlan) oldEnd;
	}
	
	/**
	 * @generated
	 */
	protected AbstractPlan getNewTarget()
	{
		return (AbstractPlan) newEnd;
	}
}

 ...
 * @generated
 */
public class ActivationPlanNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart
{
	 ...
	 * @generated
	 */
	public ActivationPlanNameEditPart(View view)
	{
		super(view);
	}
			...
			parser = GpmnParserProvider
					.getParser(
							...
							GpmnVisualIDRegistry
									.getType(jadex.tools.gpmn.diagram.edit.parts.ActivationPlanNameEditPart.VISUAL_ID));
		}
		return parser;
	}

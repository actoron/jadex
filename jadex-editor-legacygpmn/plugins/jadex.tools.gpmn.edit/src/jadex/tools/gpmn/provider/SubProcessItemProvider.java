...
/**
 * This is the item provider adapter for a {@link jadex.tools.gpmn.SubProcess} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubProcessItemProvider extends AbstractNodeItemProvider implements
		...
		ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	/**
	 * This adds a property descriptor for the Processref feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubProcess_processref_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_SubProcess_processref_feature", "_UI_SubProcess_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 GpmnPackage.Literals.SUB_PROCESS__PROCESSREF,
				 true,
				 false,
				 false,

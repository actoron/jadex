 ...
 */
public class ComponentManagementService_Server extends ComponentManagementService
{
	public ComponentManagementService_Server(IServiceContainer container, boolean autoshutdown) {

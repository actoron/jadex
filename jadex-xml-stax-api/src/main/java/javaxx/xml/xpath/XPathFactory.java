...
package javaxx.xml.xpath;

/**
 * <p>An <code>XPathFactory</code> instance can be used to create
 * {@link javaxx.xml.xpath.XPath} objects.</p>
 *
...
public abstract class XPathFactory {
     ...
     */
    public static final String DEFAULT_PROPERTY_NAME = "javaxx.xml.xpath.XPathFactory";
    ...
    *   </li>
    *   <li>
    *     The class loader is asked for service provider provider-configuration files matching <code>javaxx.xml.xpath.XPathFactory</code>
    ...
    */
     ...
     *
     * @param factoryClassName fully qualified factory class name that provides implementation of <code>javaxx.xml.xpath.XPathFactory</code>.
     *

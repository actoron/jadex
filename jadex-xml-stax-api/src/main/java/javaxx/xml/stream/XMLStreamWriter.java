 ...
 *
 * If javaxx.xml.stream.isRepairingNamespaces is set to false it is a fatal error if an element
 * is written with namespace URI that has not been bound to a prefix.
 *
 * If javaxx.xml.stream.isRepairingNamespaces is set to true the XMLStreamWriter implementation
...
public interface XMLStreamWriter {
   ...
   * javaxx.xml.stream.isPrefixDefaulting has not been set to true
   */

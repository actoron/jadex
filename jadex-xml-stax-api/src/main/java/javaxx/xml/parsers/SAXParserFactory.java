...
public abstract class SAXParserFactory {
    ...
    private static final String DEFAULT_PROPERTY_NAME = "javaxx.xml.parsers.SAXParserFactory";
     ...
     * <ul>
     * <li>
     * Use the <code>javaxx.xml.parsers.SAXParserFactory</code> system
     * property.
     * </li>
     * <li>
     ...
     * <code>META-INF/services/javaxx.xml.parsers.SAXParserFactory</code>
    ...
    public static SAXParserFactory newInstance() {
        try {
            return (SAXParserFactory) FactoryFinder.find(
                /* The default property name according to the JAXP spec */
                "javaxx.xml.parsers.SAXParserFactory",
     ...
     * </pre>
     *
     * @param factoryClassName fully qualified factory class name that provides implementation of <code>javaxx.xml.parsers.SAXParserFactory</code>.
     *

...
package javaxx.xml.parsers;

import javaxx.xml.validation.Schema;
...
public abstract class DocumentBuilderFactory {
    ...
    private static final String DEFAULT_PROPERTY_NAME = "javaxx.xml.parsers.DocumentBuilderFactory";
     ...
     * <ul>
     * <li>
     * Use the <code>javaxx.xml.parsers.DocumentBuilderFactory</code> system
     * property.
     * </li>
     * <li>
     ...
     * <code>META-INF/services/javaxx.xml.parsers.DocumentBuilderFactory</code>
    ...
    public static DocumentBuilderFactory newInstance() {
        try {
            return (DocumentBuilderFactory) FactoryFinder.find(
                /* The default property name according to the JAXP spec */
                "javaxx.xml.parsers.DocumentBuilderFactory",
     ...
     * </pre>
     *
     * @param factoryClassName fully qualified factory class name that provides implementation of <code>javaxx.xml.parsers.DocumentBuilderFactory</code>.
     *
    ...
    /**
     * Creates a new instance of a {@link javaxx.xml.parsers.DocumentBuilder}
    ...
    public abstract Object getAttribute(String name)
         ...
         *
         * <p>
         * All implementations are required to support the {@link javaxx.xml.XMLConstants#FEATURE_SECURE_PROCESSING} feature.

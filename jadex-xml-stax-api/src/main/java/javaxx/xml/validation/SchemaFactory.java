...
package javaxx.xml.validation;

import java.io.File;
import java.net.URL;

import javaxx.xml.transform.Source;
import javaxx.xml.transform.stream.StreamSource;
 ...
 *   <tbody>
 *     <tr>
 *       <td>{@link javaxx.xml.XMLConstants#W3C_XML_SCHEMA_NS_URI} ("<code>http://www.w3.org/2001/XMLSchema</code>")</td>
 *       <td><a href="http://www.w3.org/TR/xmlschema-1">W3C XML Schema 1.0</a></td>
 *     </tr>
 *     <tr>
 *       <td>{@link javaxx.xml.XMLConstants#RELAXNG_NS_URI} ("<code>http://relaxng.org/ns/structure/1.0</code>")</td>
...
public abstract class SchemaFactory {
     ...
     *     <code>"javaxx.xml.validation.SchemaFactory:<i>schemaLanguage</i>"</code>
     ...
     *     <code>javaxx.xml.validation.SchemaFactory</code> in the resource directory META-INF/services.
     ...
     *                          schema languages</a> for the possible values.
     *
     * @param factoryClassName fully qualified factory class name that provides implementation of <code>javaxx.xml.validation.SchemaFactory</code>.
     *
     ...
     *
     * <p>All implementations are required to support the {@link javaxx.xml.XMLConstants#FEATURE_SECURE_PROCESSING} feature.
     ...
     *      to recognize {@link javaxx.xml.transform.sax.SAXSource},
     *      {@link StreamSource},
     *      {@link javaxx.xml.transform.stax.StAXSource},
     *      and {@link javaxx.xml.transform.dom.DOMSource}.

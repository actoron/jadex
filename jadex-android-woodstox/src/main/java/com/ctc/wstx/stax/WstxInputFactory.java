...
//else System.err.println("Debug: skipping symbol table update");
    ...
    public XMLEventReader createXMLEventReader(javaxx.xml.transform.Source source)
        throws XMLStreamException
    {
        return new WstxEventReader(createEventAllocator(),
    ...
    public XMLStreamReader createXMLStreamReader(javaxx.xml.transform.Source src)
        throws XMLStreamException
    {
     ...
     *   by an event reader; false if it is not (or the purpose is not known)
     */
    protected XMLStreamReader2 createSR(javaxx.xml.transform.Source src,
                                        boolean forER)
        throws XMLStreamException
    {
        ReaderConfig cfg = createPrivateConfig();

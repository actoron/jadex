...
import javaxx.xml.transform.stream.StreamResult;
    ...
    implements OutputConfigFlags
{
         ...
         throws XMLStreamException
   {
    ...
    public XMLEventWriter createXMLEventWriter(javaxx.xml.transform.Result result)
         throws XMLStreamException
    {
    ...
    public XMLStreamWriter createXMLStreamWriter(javaxx.xml.transform.Result result)
        throws XMLStreamException
    {

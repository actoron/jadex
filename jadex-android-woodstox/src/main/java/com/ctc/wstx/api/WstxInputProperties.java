...
public final class WstxInputProperties
{
     ...
     * {@link javaxx.xml.stream.XMLStreamReader#next} is called, and only parse the rest
     ...
     * {@link javaxx.xml.stream.XMLStreamReader#next} is called, but only when the
     ...
     * using {@link javaxx.xml.stream.XMLInputFactory#RESOLVER} (and vice versa).
     */

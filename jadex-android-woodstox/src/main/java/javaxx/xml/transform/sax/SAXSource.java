...
package javaxx.xml.transform.sax;
 ...
 * {@link javaxx.xml.parsers.SAXParserFactory#setNamespaceAware(boolean awareness)} method.</p>
 *
...
public class SAXSource implements Source {
    ...
    /**
     * If {@link javaxx.xml.transform.TransformerFactory#getFeature}
     * returns true when passed this value as an argument,
     * the Transformer supports Source input of this type.
     */
    public static final String FEATURE =
        "http://javaxx.xml.transform.sax.SAXSource/feature";
     ...
     *
     * @see javaxx.xml.transform.Transformer#transform(Source xmlSource, Result outputTarget)
     */
    public SAXSource() { }

    /**
     * Create a <code>SAXSource</code>, using an {@link org.xml.sax.XMLReader}
     * and a SAX InputSource. The {@link javaxx.xml.transform.Transformer}
     * or {@link javaxx.xml.transform.sax.SAXTransformerFactory} will set itself
     ...
     * The {@link javaxx.xml.transform.Transformer} or
     * {@link javaxx.xml.transform.sax.SAXTransformerFactory} creates a

 ...
 * implmentation with the {@link javaxx.xml.transform.Transformer}.  The
...
public interface ErrorListener {
     ...
     *
     * <p>{@link javaxx.xml.transform.Transformer} can use this method to report
     ...
     *
     * @throws javaxx.xml.transform.TransformerException if the application
     * chooses to discontinue the transformation.
     *
     * @see javaxx.xml.transform.TransformerException
     */

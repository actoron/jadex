 ...
 * javaxx.xml.stream.notations and javaxx.xml.stream.entities.
 * When the current event is a DTD the following call will return a
 * list of Notations
 *  <code>List l = (List) getProperty("javaxx.xml.stream.notations");</code>
 * The following call will return a list of entity declarations:
 * <code>List l = (List) getProperty("javaxx.xml.stream.entities");</code>
 ...
 * @see javaxx.xml.stream.events.XMLEvent
 * @see XMLInputFactory
 * @see XMLStreamWriter
 */
public interface XMLStreamReader extends XMLStreamConstants {
   ...
   * If the property javaxx.xml.stream.isCoalescing is set to true
   ...
   * Regardless of value of javaxx.xml.stream.isCoalescing this method always returns coalesced content.

...
public class IntermediateResult {
	...
	private InvestigationConfiguration simConf;
...
//	private HashMap<String, HashMap<String, String>> intermediateStats = new HashMap<String, HashMap<String, String>>();
	...
	public IntermediateResult(InvestigationConfiguration simConf) {
		this.simConf = simConf;
//		initAllHashMaps();
	}

	public IntermediateResult(int currentEnsembleNumber, int currentExperimentNumber, InvestigationConfiguration simConf) {

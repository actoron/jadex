...
//		});
	...
	public void addTimer(ProcessThread thread, long duration)
	{
		...
		IClockService clock = (IClockService)interpreter.getAgentAdapter().getRootServiceProvider().getService(IClockService.class);
...
//			OAVBDIRuntimeModel.AGENTLIFECYCLESTATE_TERMINATING);
	...
	{
		return (IClockService)interpreter.getAgentAdapter().getRootServiceProvider().getService(IClockService.class);
	}

...
public class DebuggerMainPanel extends JSplitPane
{
	...
	public DebuggerMainPanel(final IControlCenter jcc, final IComponentDescription desc)
	{
		...
		SServiceProvider.getServiceUpwards(jcc.getPlatformAccess().getServiceProvider(), ILibraryService.class)
							...
							public void resultAvailable(final Object result)
							{
								...
								SwingUtilities.invokeLater(new Runnable()
								{
									public void run()
									{
										...
										{
											Collection	breakpoints	= (Collection)exta.getModel().getProperty(KEY_DEBUGGER_BREAKPOINTS, libservice);

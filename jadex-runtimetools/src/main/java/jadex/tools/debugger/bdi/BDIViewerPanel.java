	...
	protected static void	getInitialEvents(IInternalAccess ia, IOAVState state, Object capa, List events)
	{
		...
		if(beliefs!=null)
		{
			for(Iterator it=beliefs.iterator(); it.hasNext(); )
			{
				...
				events.add(new ComponentChangeEvent(IComponentChangeEvent.EVENT_TYPE_CREATION, IComponentChangeEvent.SOURCE_CATEGORY_FACT, info.getType(), belief.toString(), ia.getComponentIdentifier(), 0, info));
			}
		}
		...
		if(beliefsets!=null)
		{
			for(Iterator it=beliefsets.iterator(); it.hasNext(); )
			{
				...
				events.add(new ComponentChangeEvent(IComponentChangeEvent.EVENT_TYPE_CREATION, IComponentChangeEvent.SOURCE_CATEGORY_FACT, info.getType(), beliefset.toString(), ia.getComponentIdentifier(), 0, info));
			}
		}
		...
		if(goals!=null)
		{
			for(Iterator it=goals.iterator(); it.hasNext(); )
			{
				...
				events.add(new ComponentChangeEvent(IComponentChangeEvent.EVENT_TYPE_CREATION, IComponentChangeEvent.SOURCE_CATEGORY_GOAL, info.getType(), goal.toString(), ia.getComponentIdentifier(), 0, info));
			}
		}
		...
		if(plans!=null)
		{
			for(Iterator it=plans.iterator(); it.hasNext(); )
			{
				...
				events.add(new ComponentChangeEvent(IComponentChangeEvent.EVENT_TYPE_CREATION, IComponentChangeEvent.SOURCE_CATEGORY_PLAN, info.getType(), plan.toString(), ia.getComponentIdentifier(), 0, info));
			}
		}

 ...
 * 
 */
public abstract class AbstractInputConnection extends AbstractConnection implements IInputConnection
{
	/** The data. */
	 ...
	 */
	public AbstractInputConnection(MessageService ms, IComponentIdentifier sender, 

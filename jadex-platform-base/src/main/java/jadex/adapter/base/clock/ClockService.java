 ...
 */
public class ClockService implements IClockService, IPlatformService
{
	//-------- attributes --------
	 ...
	 */
	public void setClock(String type)
	{
		IClock clock = null;
		if(IClock.TYPE_CONTINUOUS.equals(type))
			clock = new ContinuousClock(this.clock, (IThreadPool)platform.getService(ThreadPoolService.class));
		else if(IClock.TYPE_SYSTEM.equals(type))
			clock = new SystemClock(this.clock, (IThreadPool)platform.getService(ThreadPoolService.class));

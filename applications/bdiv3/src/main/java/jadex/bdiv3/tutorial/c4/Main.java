...
public class Main 
{
	...
	public static void main(String[] args) 
	{
		...
		//CreationInfo ci = new CreationInfo().setFilenameClass(ClockBDI.class);
		CreationInfo ci = new CreationInfo().setFilename("jadex/bdiv3/tutorial/c4/TranslationBDI.class");
		platform.createComponent(ci).get();
		ci = new CreationInfo().setFilename("jadex/bdiv3/tutorial/c4/ClockBDI.class");
		platform.createComponent(ci).get();
	}
}

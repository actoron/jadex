...
public class Main 
{
	...
	public static void main(String[] args) 
	{
		...
		CreationInfo ci = new CreationInfo().setFilename("jadex/bdiv3/tutorial/stamp/StampBDI.class");
		platform.createComponent(ci).get();
		ci = new CreationInfo().setFilename("jadex/bdiv3/tutorial/stamp/WorkpieceBDI.class");
		platform.createComponent(ci).get();
	}
}

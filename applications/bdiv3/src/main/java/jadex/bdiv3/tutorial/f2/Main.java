...
public class Main 
{
	...
	public static void main(String[] args) 
	{
		...
		CreationInfo ci = new CreationInfo().setFilename("jadex/bdiv3/tutorial/f2/TranslationBDI.class");
		platform.createComponent(ci).get();
		ci = new CreationInfo().setFilename("jadex/bdiv3/tutorial/f2/UserBDI.class");
		platform.createComponent(ci).get();
	}
}

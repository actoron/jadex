...
public class MicroStepPlan extends Plan
{
	...
	public void body()
	{
		// This testcase is not valid any longer
		// Although rule execution is immediate, a plan is added to the capa in the decoupled ExecutePlanStep action
...
//		getBeliefbase().getBeliefSet("testcap.reports").addFact(tr);
		...
		// todo: 
		waitFor(100);
		TestReport tr = new TestReport("#2", "Resetting beliefs. As conditions should not trigger, plan will not be interrupted (use introspector to check");

...
public class FactFetcherPlan extends Plan
{
	...
	{	
		...
		Collection services = getAgent().getComponentFeature(IRequiredServicesFeature.class).searchLocalServices(new ServiceQuery<>(IBeliefGetter.class, RequiredServiceInfo.SCOPE_LOCAL));

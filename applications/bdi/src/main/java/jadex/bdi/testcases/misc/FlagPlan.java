...
public class FlagPlan extends Plan
{
	...
	public void body()
	{
		IComponentManagementService cms = getAgent().getFeature(IRequiredServicesFeature.class).searchLocalService(new ServiceQuery<>(IComponentManagementService.class));

...
public class DataPacket {
	...
	public IBluetoothDevice getDestinationDevice() {
		return new AndroidBluetoothDevice(BluetoothAdapter.getDefaultAdapter().getRemoteDevice(Dest));
	}


	public IBluetoothDevice getSourceDevice() {
		return new AndroidBluetoothDevice(BluetoothAdapter.getDefaultAdapter().getRemoteDevice(Src));
	}

...
[plan API of Jadex](https://www.activecomponents.org/forward.html?type=javadoc&path=jadex/bdiv3/runtime/IPlan.html),
...
[future](https://www.activecomponents.org/forward.html?type=javadoc&path=jadex/commons/future/IFuture.html) object that allows

...
[here](https://www.activecomponents.org/forward.html?type=javadoc&path=jadex/bdiv3/features/IBDIAgentFeature.html).
...
[Javadoc documentation](https://www.activecomponents.org/forward.html?type=javadoc&path=jadex/bdiv3/annotation/Trigger.html).
...
[@Goal annotation](https://www.activecomponents.org/forward.html?type=javadoc&path=jadex/bdiv3/annotation/Goal.html).

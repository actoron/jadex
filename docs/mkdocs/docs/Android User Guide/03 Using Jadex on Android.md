...
To adjust Jadex Platform behaviour, use these methods 
```java
...
To dispatch events in an Agent, just use the *dispatchEvent()* method (you need to extend AndroidMicroAgent for this method):

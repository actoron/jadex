<span>Chapter 7 - External Access</span> 
========================================
...
<span>Exercise F1 - Chat Bot</span> 
-----------------------------------
...
<span>Exercise F2 - Component Viewer</span> 
-------------------------------------------
...
<span>Exercise F3 - Scheduling Steps on Components</span> 
---------------------------------------------------------
...
<span>Exercise F4 - Scheduling Steps on Remote Components</span> 
----------------------------------------------------------------
...
-   For each inner *IComponentStep* class, add an *@XMLClassname("some\_identifier")* annotation. Of course you should use different identifiers for each occurrence (three in total).

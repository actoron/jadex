...
<span>Defining Plan Heads in the ADF</span> 
-------------------------------------------
...
<span>Defining Plan Applicability with Pre- and Context Conditions</span> 
-------------------------------------------------------------------------
...
<span>Parameters, Binding, and Parameter Mapping</span> 
-------------------------------------------------------
...
<span>Implementing a Plan Body in Java</span> 
---------------------------------------------

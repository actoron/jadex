...
/**
 * This is the item provider adapter for a {@link jadex.tools.gpmn.NamedObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedObjectItemProvider extends EModelElementItemProvider
		...
		ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			getString("_UI_NamedObject_type") : //$NON-NLS-1$
			getString("_UI_NamedObject_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}

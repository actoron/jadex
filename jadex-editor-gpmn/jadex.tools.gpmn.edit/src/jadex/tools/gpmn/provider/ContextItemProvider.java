...
/**
 * This is the item provider adapter for a {@link jadex.tools.gpmn.Context} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextItemProvider extends EModelElementItemProvider implements
		...
		ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	/**
	 * This adds a property descriptor for the Gpmn Diagram feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGpmnDiagramPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Context_gpmnDiagram_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Context_gpmnDiagram_feature", "_UI_Context_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 GpmnPackage.Literals.CONTEXT__GPMN_DIAGRAM,
				 true,
				 false,
				 true,
				 null,

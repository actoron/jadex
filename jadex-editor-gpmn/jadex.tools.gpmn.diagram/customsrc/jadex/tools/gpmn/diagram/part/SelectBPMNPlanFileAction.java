...
public class SelectBPMNPlanFileAction extends AbstractFileAction implements IObjectActionDelegate
{
	...
	public void run(IAction action)
	{
		...
		String bpmnPlanFile = ((BpmnPlan) ((View) selectedElement.getModel()).getElement()).getPlanref();
		...
		final BpmnPlan plan = (BpmnPlan) ((View) selectedElement.getModel()).getElement();

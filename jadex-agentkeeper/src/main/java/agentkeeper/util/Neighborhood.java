...
public class Neighborhood {
	...
	public static final Vector2Int[] complexDirections = {case1,case2,case3,case4,case5,case6,case7,case8, bigcase1, bigcase2, bigcase3,
...
//	}
	...
	public static String reCalculateNeighborhood(IVector2 iMyPos, Set<SpaceObject> nearFields) {
		...
		if (neighborcases.contains(new Integer(3))) {
			if (!neighborcases.contains(new Integer(2))
					|| !neighborcases.contains(new Integer(4))) {
		...
		if (neighborcases.contains(new Integer(5))) {
			if (!neighborcases.contains(new Integer(4))
					|| !neighborcases.contains(new Integer(6))) {
		...
		if (neighborcases.contains(new Integer(7))) {
			if (!neighborcases.contains(new Integer(6))
					|| !neighborcases.contains(new Integer(8))) {
...
//		String ret = "00000000";
		 ...
		 if(alternatives && (neighborhood.equals("00111110")||neighborhood.equals("10001111")||neighborhood.equals("11100011")||neighborhood.equals("11111000")))
		 {

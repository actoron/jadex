...
//@author Christian Wiech (extension for Strings with pathseperator)
public class FileAutoCompleter extends AutoCompleter
{ 
	private String thePathSeperator = null;
	
    public FileAutoCompleter(JTextComponent comp, String pathSeperator){ 
        super(comp); 
    ...
    protected boolean updateListData(){ 
        ...
        if (thePathSeperator != null)
        {
        	...
        	else index3 += thePathSeperator.length();
        	if (index3 > index)
        		return false;
        }

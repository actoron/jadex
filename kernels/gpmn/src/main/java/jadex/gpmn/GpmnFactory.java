...
//		final IFuture<Void> sfuture = super.startService();
		...
		SServiceProvider.searchService((IServiceProvider)ia.getServiceContainer(), new ServiceQuery<>( ILibraryService.class, RequiredServiceInfo.SCOPE_PLATFORM))
...
//				libservice.addLibraryServiceListener(libservicelistener);
				...
				SServiceProvider.searchService((IServiceProvider)ia.getServiceContainer(), new ServiceQuery<>( IThreadPoolService.class, RequiredServiceInfo.SCOPE_PLATFORM)).addResultListener(ia.createResultListener(new DefaultResultListener()
				{

...
//		final IFuture<Void> sfuture = super.startService();
		...
		(IServiceProvider)ia.getServiceContainer().searchService( new ServiceQuery<>( ILibraryService.class, ServiceScope.PLATFORM))
...
//				libservice.addLibraryServiceListener(libservicelistener);
				...
				(IServiceProvider)ia.getServiceContainer().searchService( new ServiceQuery<>( IThreadPoolService.class, ServiceScope.PLATFORM)).addResultListener(ia.createResultListener(new DefaultResultListener()
				{

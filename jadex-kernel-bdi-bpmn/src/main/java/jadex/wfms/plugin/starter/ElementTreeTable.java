 ...
 */
public class ElementTreeTable extends JScrollPane
{
	//-------- constants --------
	...
	public static String NODE_ELEMENT = "element_node";
	...
	{
		// Node icons.
		NODE_ELEMENT, SGUI.makeIcon(ElementTreeTable.class, "/jadex/tools/common/images/new_agent.png"), 
		NODE_ELEMENT, SGUI.makeIcon(ElementTreeTable.class, "/jadex/tools/common/images/new_platform.png")
	});
	 ...
	 *  Open the gui.
	 */
	public ElementTreeTable(String platname)
	{
		...
		addNodeType(new TreeTableNodeType(NODE_ELEMENT, new Icon[]{icons.getIcon(NODE_ELEMENT)}, new String[]{"name", "address"}, new String[]{"Name", "Address"}));
		...
		this.treetable = new JTreeTable(new DefaultTreeTableModel(platform, getNodeType(NODE_ELEMENT).getColumnNames()));
...
//		header.setColumnWidths(treetable.getColumnModel().getColumn(0), 100, 100, -1);
	...
	{		
		...
		platform.add(new DefaultTreeTableNode(getNodeType(NODE_ELEMENT), description, values));

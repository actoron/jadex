 ...
 * @author nehon
 */
public class FocusCamera implements ActionListener, AnalogListener, Control {
     ...
     */
    public FocusCamera(Camera cam, final Spatial target) {
        this(cam);
     ...
     */
    public FocusCamera(Camera cam, InputManager inputManager) {
        this(cam);
     ...
     * @param inputManager the inputManager of the application to register inputs
     */
    public FocusCamera(Camera cam, final Spatial target, InputManager inputManager) {
        this(cam, target);
        registerWithInput(inputManager);
    }

...
public class Operation
{
	 ...
	 */
	public Operation(UnaryExpression left, UnaryExpression right, String operator)
	{
		this.left	= left;
		this.right	= right;
	...
	public boolean	equals(Object o)
	{
		return o instanceof Operation
			&& ((Operation)o).getLeftValue().equals(getLeftValue())
			&& ((Operation)o).getRightValue().equals(getRightValue())
			&& ((Operation)o).getOperator().equals(getOperator());
	}

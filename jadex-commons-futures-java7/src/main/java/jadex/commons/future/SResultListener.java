...
public class SResultListener
{
	 ...
	 */
	private final static IFunctionalResultListener< ? extends Object>	EMPTY_SUCCESS_LISTENER		
		= new IFunctionalResultListener<Object>()
	{
	 ...
	 */
	private final static IFunctionalExceptionListener	EMPTY_EXCEPTION_LISTENER	
	...
	/**
	 * Creates an {@link IResultListener} that delegates all results to a given
	 * Future.
	 * 
	 ...
	 * Future and results to a given SuccessListener.
	 * 
	 ...
	 * @param countReachedListener Listener to be called when the given number
	 *        is reached.
	 ...
	 * @param countReachedListener Listener to be called when the given number
	 *        is reached.
	 * @param intermediateListener Listener to be called for intermediate
	 *        Results.
	 * @param exListener Listener to be called for exceptions.
	 * @return {@link CounterResultListener}
	 */
	public static <E> CounterResultListener<E> countResults(int num, IFunctionalResultListener<Void> countReachedListener, IFunctionalResultListener<E> intermediateListener,
	 ...
	 * 
	 * @param sucListener The SuccessListener.
	 * @param exListener The ExceptionListener. If <code>null</code>, exceptions
	 *        are logged.
	 * @return {@link IResultListener}
	 */

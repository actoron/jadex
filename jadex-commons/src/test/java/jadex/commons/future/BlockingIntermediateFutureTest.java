...
//				for(int i=1; fut.hasNextIntermediateResult(sus) && i<2; i++)
//				{
//					assertEquals("result"+i, fut.getNextIntermediateResult(sus));
//				}
//				assertEquals(false, suspended);
//	
//				// Retrieve next result (should be blocking)
//				assertEquals("result3", fut.getNextIntermediateResult(sus));
//				assertEquals(true, suspended);
//	
//				// Check for next result (should be blocking on check)
//				suspended	= false;
//				assertEquals(true, fut.hasNextIntermediateResult(sus));
//				assertEquals(true, suspended);
//				suspended	= false;
//				assertEquals("result4", fut.getNextIntermediateResult(sus));
//				assertEquals(false, suspended);
//				
//				// Check for graceful exit (should block until finished)
//				if(exit)
//				{
//					assertEquals(false, fut.hasNextIntermediateResult(sus));					
//					assertEquals(true, suspended);
//					suspended	= false;
//				}
//				
...
//					try
//					{
//						fut.getNextIntermediateResult(sus);
...
//		{
//			this.it	= new IntermediateFutureIterator<String>(fut, new ThreadSuspendable()
//			{
//				public void suspend(IFuture<?> future, long timeout)
//				{
//					suspended	= true;

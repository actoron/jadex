...
public class BeanContextServicesSupport extends BeanContextSupport implements
     ...
     * </p>
     * 
     * @see jadex.commons.beans.beancontext.BeanContextServices#addService(java.lang.Class,
     ...
     * </p>
     * 
     * @see jadex.commons.beans.beancontext.BeanContextSupport#bcsPreDeserializationHook(java.io.ObjectInputStream)
     */
     ...
     * </p>
     * 
     * @see jadex.commons.beans.beancontext.BeanContextSupport#bcsPreSerializationHook(java.io.ObjectOutputStream)
     */
     ...
     * </p>
     * 
     * @see jadex.commons.beans.beancontext.BeanContextSupport#childJustRemovedHook(java.lang.Object,
     ...
     * 
     * @see jadex.commons.beans.beancontext.BeanContextSupport#createBCSChild(java.lang.Object,
     *      java.lang.Object)
     */
     ...
     * @see jadex.commons.beans.beancontext.BeanContextServices#getCurrentServiceClasses()
     */
     ...
     * 
     * @see jadex.commons.beans.beancontext.BeanContextServices#getCurrentServiceSelectors(java.lang.Class)
     */
     ...
     * @throws TooManyListenersException
     * @see jadex.commons.beans.beancontext.BeanContextServices#getService(jadex.commons.beans.beancontext.BeanContextChild,
     ...
     * @see jadex.commons.beans.beancontext.BeanContextServices#hasService(java.lang.Class)
     */
     ...
     * 
     * @see jadex.commons.beans.beancontext.BeanContextChildSupport#initializeBeanContextResources()
     */
     ...
     * 
     * @see jadex.commons.beans.beancontext.BeanContextChildSupport#releaseBeanContextResources()
     */
     ...
     * @see jadex.commons.beans.beancontext.BeanContextServices#revokeService(java.lang.Class,
     ...
     * 
     * @see jadex.commons.beans.beancontext.BeanContextServicesListener#serviceAvailable(jadex.commons.beans.beancontext.BeanContextServiceAvailableEvent)
     */
     ...
     * <code>BeanContextServices</code> of the event.
     * 
     * @see jadex.commons.beans.beancontext.BeanContextServiceRevokedListener#serviceRevoked(jadex.commons.beans.beancontext.BeanContextServiceRevokedEvent)
     */
    public void serviceRevoked(BeanContextServiceRevokedEvent event) {
        if (null == event) {
            throw new NullPointerException(Messages.getString("beans.1C")); //$NON-NLS-1$

package jadex.android.application.demo.bpmn.tasks;
...
@Task(description="Show an activity on the screen", parameters={
		...
		@TaskParameter(name="attributes", clazz=HashMap.class, direction=TaskParameter.DIRECTION_IN, description="A HashMap containing all attributes that shall be passed to the activity.")
})
public class ShowActivityTask extends AbstractTask
{
	...
	{
		String desc = "Show an activity on the screen";
		
		ParameterMetaInfo p1 = new ParameterMetaInfo(ParameterMetaInfo.DIRECTION_IN, 
				android.content.Context.class, "androidContext", null, "The context of the Android application, used to activate the activity");
		ParameterMetaInfo p2 = new ParameterMetaInfo(ParameterMetaInfo.DIRECTION_IN, 
				Class.class, "activityClass", null, "The activity class (used for explicitly starting Activity)");
		ParameterMetaInfo p3 = new ParameterMetaInfo(ParameterMetaInfo.DIRECTION_IN, 
				HashMap.class, "attributes", null, "A HashMap containing all attributes that shall be passed to the activity");
		
		return new TaskMetaInfo(desc, new ParameterMetaInfo[]{p1, p2, p3}); 
	}
}

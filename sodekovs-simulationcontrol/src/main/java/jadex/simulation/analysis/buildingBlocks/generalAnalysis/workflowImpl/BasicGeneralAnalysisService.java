...
//	@Override
	public IFuture getModelParameter(String modelName, String modelType) {
		...
		IAParameterCollection inputParameter = (IAParameterCollection) iParaFut.get(susThread);
		
		IFuture oParaFut = service.resultParamter(modelName);
		IAParameterCollection outputParameter = (IAParameterCollection) oParaFut.get(susThread);

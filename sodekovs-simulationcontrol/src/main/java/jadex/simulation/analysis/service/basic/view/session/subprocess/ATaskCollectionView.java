package jadex.simulation.analysis.service.basic.view.session.subprocess;
						...
						showButton.addActionListener(new ActionListener()
						{
							...
							public void actionPerformed(ActionEvent e)
							{
								...
								if (select != null)
								{
									...
									ATaskInternalFrame frame = new ATaskInternalFrame("Task: " + taskView.getDisplayedObject().getActivity().getName() + " (" + select + ")", true, true, true, false);
...
//						System.out.println(activity.getClazz());
	...
	private void update(IATaskView view)
	{
		...
		// add(specialComp, new GridBagConstraints(0, 1, GridBagConstraints.REMAINDER, GridBagConstraints.REMAINDER, 1, 1, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(1, 1, 1, 1), 0,
		// 0));

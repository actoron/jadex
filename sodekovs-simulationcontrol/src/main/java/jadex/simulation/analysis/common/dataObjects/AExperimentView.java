...
public class AExperimentView extends ADataObjectView implements IADataView
{
	...
	private void init()
	{
		component.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED), "Experimenteller Rahmen", TitledBorder.LEADING, TitledBorder.DEFAULT_POSITION, new Font("default", 0, 14), null));
...
//							 comp.repaint();
		...
		expButton.setPreferredSize(new Dimension(250, 25));
		...
		inputButton.setPreferredSize(new Dimension(250, 25));
		...
		outputButton.setPreferredSize(new Dimension(250, 25));
		...
		modelButton.setPreferredSize(new Dimension(250, 25));
	...
	{
		IAExperiment expframe = AExperimentFactory.createTestAExperiment();

		JFrame frame = new JFrame();
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.setSize(1024, 786);
		frame.add(ADataViewFactory.createView(expframe).getComponent());

...
public class AExperimentBatch extends ADataObject implements IAExperimentBatch
{
	...
	public AExperimentBatch(String name)
	{
		...
		synchronized (mutex)
		{
			experimentMap = Collections.synchronizedMap(new HashMap<String, IAExperiment>());
			view = new AExperimentBatchView(this);
			allocation = Collections.synchronizedMap(new HashMap<IAExperiment, IAnalysisService>());
		}
	}

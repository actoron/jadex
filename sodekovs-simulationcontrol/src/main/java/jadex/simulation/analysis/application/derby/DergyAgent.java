...
@ProvidedServices({@ProvidedService(type=IASaveDataobjectService.class, implementation=@Implementation(expression="new DerbySaveDataobjectService($component.getExternalAccess())"))})
...
public class DergyAgent extends MicroAgent
{	

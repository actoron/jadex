...
public class ADatenobjekteParametrisierenGUIService extends ADatabasedService implements IADatenobjekteParametrisierenGUIService
{

	public ADatenobjekteParametrisierenGUIService(IExternalAccess instance)
	{
		super(instance, IADatenobjekteParametrisierenGUIService.class, true);
	}

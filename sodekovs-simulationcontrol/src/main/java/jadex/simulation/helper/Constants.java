...
public class Constants {
	...
	// Denotes the stock level of red: "stock < 1"
	public static final String STOCK_LEVEL_RED = "stockLevelRed";
	
	// Denotes the stock level of green: "stock > 0 && stock < capacity"
	public static final String STOCK_LEVEL_GREEN = "stockLevelGreen";
	
	// Denotes the stock level of blue: "stock >= capacity"
	public static final String STOCK_LEVEL_BLUE = "stockLevelBlue";

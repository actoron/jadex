			...
			public void resultAvailable(Object result)
			{
					...
					.addResultListener(new IResultListener()
				{
					public void resultAvailable(Object result)
					{
						...
						rms.getServiceProxy(getComponentIdentifier(), platid, IMathService.class, RequiredServiceInfo.SCOPE_PLATFORM, null).addResultListener(createResultListener(new IResultListener()
						{
							public void resultAvailable(Object result)
							{

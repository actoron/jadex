    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(jadex.micro.examples.ws.geoip.gen.GeoIPService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = jadex.micro.examples.ws.geoip.gen.GeoIPService.class.getResource(".");

...
public class BenchmarkingPlugin extends AbstractServicePlugin
{
	...
	static
	{
		icons.put("benchmark", SGUI.makeIcon(BenchmarkingPlugin.class, "/jadex/benchmarking/viewer/images/benchmark2.png"));
		icons.put("benchmark_sel", SGUI.makeIcon(BenchmarkingPlugin.class, "/jadex/benchmarking/viewer/images/benchmark_sel.png"));
	}

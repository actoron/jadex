...
public class SimObject
{
	 ...
	 */
	public SimObject(Integer objectId, String type, Map properties, List tasks,
			IVector2 initialPosition, boolean sigDest)
	{
		objectId_ = objectId;
		type_ = type;
	...
	/**
	 * Returns access to the current position of the object. Object must be
	 * locked before using the access.
	 * 
	...
	/**
	 * Assigns a new position for the object. Unlike setPosition, this does not
	 * overwrite the position object.
	 * 
	 * @param position new position
	 */
	...
	public synchronized void fireSimulationEvent(SimulationEvent evt)
	{
		...
		{
			ISimulationEventListener listener = (ISimulationEventListener)it
					.next();

...
public class OAVBDIXMLReader
{
	...
	static
	{
		...
		typeinfos.add(new OAVMappingInfo("expression", OAVBDIMetaModel.expression_type, null, null, null, new ExpressionProcessor()));
		typeinfos.add(new OAVMappingInfo("property", OAVBDIMetaModel.expression_type, null, null, null, new ExpressionProcessor()));
		typeinfos.add(new OAVMappingInfo("fact", OAVBDIMetaModel.expression_type, null, null, null, new ExpressionProcessor()));
		typeinfos.add(new OAVMappingInfo("facts", OAVBDIMetaModel.expression_type, null, null, null, new ExpressionProcessor()));
		typeinfos.add(new OAVMappingInfo("value", OAVBDIMetaModel.expression_type, null, null, null, new ExpressionProcessor()));
		typeinfos.add(new OAVMappingInfo("values", OAVBDIMetaModel.expression_type, null, null, null, new ExpressionProcessor()));

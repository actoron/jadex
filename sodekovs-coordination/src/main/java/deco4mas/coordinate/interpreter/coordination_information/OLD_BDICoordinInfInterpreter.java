 ...
 */
public class OLD_BDICoordinInfInterpreter extends SimplePropertyObject implements ICoordinationInformationInterpreter
{
...
<<<<<<< .mine
												...
												{ // check role
													...
													if ( 1==1 || (coordinationSpaceObj.getProperty(CoordinationInfo.AGENT_ELEMENT_TYPE)).equals(elementType))
													{
														if ( 1==1 || ((String) coordinationSpaceObj.getProperty(CoordinationInfo.AGENT_ELEMENT_NAME) )
															.equals(elementId))
														{

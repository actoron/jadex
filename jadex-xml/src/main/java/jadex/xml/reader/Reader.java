		...
		while(parser.hasNext())
		{
			...
			if(next==XMLStreamReader.COMMENT)
			{
				if(readignore==0)
					...
					System.out.println("Ignoring: "+parser.getText());
				...
				else if(readignore==0)
				{
					...
					if(stack.size()>0)
					{
						...
						if(pse!=null)
						{
							...
							SubobjectInfo linkinfo = getSubobjectInfoRead(localname, fullpath, patypeinfo, topse!=null? topse.getRawAttributes(): null);

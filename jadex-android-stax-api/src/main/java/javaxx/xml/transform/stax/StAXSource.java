...
package javaxx.xml.transform.stax;
 ...
 * a <code>Source</code>, e.g. {@link javaxx.xml.transform.Transformer},
 * {@link javaxx.xml.validation.Validator} which accept
...
public class StAXSource implements Source {
    ...
    /** If {@link javaxx.xml.transform.TransformerFactory#getFeature(String name)}
     * returns true when passed this value as an argument,
     * the Transformer supports Source input of this type.
     */
    public static final String FEATURE =
        "http://javaxx.xml.transform.stax.StAXSource/feature";

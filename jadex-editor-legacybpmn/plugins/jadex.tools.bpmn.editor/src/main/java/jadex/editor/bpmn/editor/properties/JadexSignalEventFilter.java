 ...
 * 
 */
public class JadexSignalEventFilter implements IFilter
{
	public boolean select(Object toTest)
	{
		...
		if (toTest instanceof ActivityEditPart || toTest instanceof Activity2EditPart)
		{
			...
			if (part.getModel() instanceof View)
			{
				...
				ret = ActivityType.EVENT_INTERMEDIATE_SIGNAL_LITERAL.equals(model.getActivityType())
					|| ActivityType.EVENT_START_SIGNAL_LITERAL.equals(model.getActivityType())
					|| ActivityType.EVENT_END_SIGNAL_LITERAL.equals(model.getActivityType());
			}
		}

 ...
 * 
 */
public class JadexMessageEventFilter implements IFilter
{
	public boolean select(Object toTest)
	{
		...
		if (toTest instanceof ActivityEditPart || toTest instanceof Activity2EditPart)
		{
			...
			if (part.getModel() instanceof View)
			{
				...
				ret = ActivityType.EVENT_INTERMEDIATE_MESSAGE_LITERAL.equals(model.getActivityType())
					|| ActivityType.EVENT_START_MESSAGE_LITERAL.equals(model.getActivityType())
					|| ActivityType.EVENT_END_MESSAGE_LITERAL.equals(model.getActivityType());
			}
		}

...
import org.eclipse.stp.bpmn.diagram.providers.BpmnParserProvider;
		...
		ITextAwareEditPart
{
	...
	static
	{
		registerSnapBackPosition(
				BpmnVisualIDRegistry
						.getType(jadex.editor.bpmn.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID),
				new Point(0, -10));
	}
	...
	protected void createDefaultEditPolicies()
	{
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new BpmnTextSelectionEditPolicy());
	...
	public void setLabelText(String text)
	{
		...
		if (sfEditPolicy instanceof BpmnTextSelectionEditPolicy)
		{
			((BpmnTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser()
	{
		...
		{
			// HACK!
			BpmnParserProvider provider = new BpmnParserProvider();
			parser = provider.getParser(
					BpmnElementTypes.SequenceEdge_3001);
		}
		return parser;
	}

 ...
 */
public class MComponentType extends MStartable implements ICacheableModel
{
	//-------- attributes --------
...
//		modelinfo.setComponentInstances(components);
		...
		{
			MConfiguration mapp = (MConfiguration)apps.get(i);
...
//				System.out.println("autoshutdown: "+val+" "+mapp.getName());
	...
	public static IErrorReport buildReport(String modelname, String filename, String[] cats, MultiCollection entries, Map externals)
	{
			...
			new String[]{"Component", "Configuration"}, entries, null)
		{
			...
			{
				return "Component".equals(category) && obj instanceof MSubcomponentType
					|| "Configuration".equals(category) && obj instanceof MConfiguration;
			}
			...
			public String getObjectName(Object obj)
			{
				...
				if(obj instanceof MSubcomponentType)
				{
					name	= ((MSubcomponentType)obj).getName();
				}
				else if(obj instanceof MConfiguration)
				{
					name	= ((MConfiguration)obj).getName();
					type	= "Configuration";
				}

 ...
 */
@Agent(predecessors={ "jadex.platform.service.settings.SettingsAgent", "jadex.platform.service.monitoring.MonitoringAgent" },
...
@ProvidedServices(@ProvidedService(type=IClockService.class, scope=ServiceScope.PLATFORM, implementation=@Implementation(

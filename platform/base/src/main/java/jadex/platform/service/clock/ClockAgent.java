 ...
 */
@Agent(autostart=@Autostart(value=Boolean3.TRUE, predecessors=MonitoringAgent.class))
@Arguments(@Argument(name="simulation", clazz=boolean.class, defaultvalue="false"))
@ProvidedServices(@ProvidedService(type=IClockService.class, scope=Binding.SCOPE_PLATFORM, implementation=@Implementation(

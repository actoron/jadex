...
//				CreationInfo ci = psi.getArguments()!=null? new CreationInfo(psi.getArguments()): null;
	...
	public class ForwardHandler implements InvocationHandler
	{
		...
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable
		{
			...
			IService ser = (IService)agent.getFeature(IRequiredServicesFeature.class).searchLocalService(new ServiceQuery<>(servicetype).setProvider(poolser.getServiceIdentifier().getProviderId()));

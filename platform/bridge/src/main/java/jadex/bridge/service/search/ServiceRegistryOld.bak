 ...
 */
public class ServiceRegistryOld implements IServiceRegistry // extends AbstractServiceRegistry
{
	//-------- attributes --------
...
//	protected volatile long searchtime;
	 ...
	 */
	public ServiceRegistryOld(IComponentIdentifier cid, long delay)
	{
		this.cid = cid;

...
public class LinkedModelRepositoryService implements IModelRepositoryService
{
	...
	{
		final Future ret = new Future();
		ia.getServiceContainer().searchService( new ServiceQuery<>( ILibraryService.class, ServiceScope.PLATFORM)).addResultListener(ia.createResultListener(new DelegationResultListener(ret)
		{
			public void customResultAvailable(Object result)
			{
